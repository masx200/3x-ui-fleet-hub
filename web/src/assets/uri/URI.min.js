...
(function (r, x) {
       ...
       /*
Uncaught TypeError: Cannot set properties of undefined (setting 'IPv6')
       */
       globalThis,
       function (r) {
              var x = r && r.IPv6;
              return {
                     best: function (k) {
                            ...
                            for (q = 0; q < m && "" !== k[q]; q++);
                            if (q < d) {
                                   for (k.splice(q, 1, "0000"); k.length < d;) {
                                          k.splice(q, 0, "0000");
                                   }
                            }
                            for (q = 0; q < d; q++) {
...
(function (r) {
       function x(l) {
              throw new RangeError(G[l]);
       }
       function k(l, t) {
              for (var H = l.length, y = []; H--;) y[H] = t(l[H]);
              return y;
       }
       function m(l, t) {
              var H = l.split("@"), y = "";
              1 < H.length && (y = H[0] + "@", l = H[1]);
              l = l.replace(w, ".");
              l = l.split(".");
              t = k(l, t).join(".");
              return y + t;
       ...
       function d(l) {
              for (var t = [], H = 0, y = l.length, I, M; H < y;) {
                     I = l.charCodeAt(H++),
                            55296 <= I && 56319 >= I && H < y
                                   ? (M = l.charCodeAt(H++),
                                          56320 == (M & 64512)
       ...
       function B(l, t, H) {
              var y = 0;
              l = H ? v(l / 700) : l >> 1;
              for (l += v(l / t); 455 < l; y += 36) l = v(l / 35);
              return v(y + 36 * l / (l + 38));
       }
       function z(l) {
              var t = [], H = l.length, y = 0, I = 128, M = 72, a, b;
              var c = l.lastIndexOf("-");
              0 > c && (c = 0);
              for (a = 0; a < c; ++a) {
                     128 <= l.charCodeAt(a) && x("not-basic"),
              ...
              for (c = 0 < c ? c + 1 : 0; c < H;) {
                     ...
                     for (b = 36;; b += 36) {
                            ...
                            f = 10 > f - 48
                                   ...
                                   ? f - 97
                                   : 36;
                            (36 <= f || f > v((2147483647 - y) / e)) &&
                                   x("overflow");
                            y += f * e;
                            var n = b <= M ? 1 : b >= M + 26 ? 26 : b - M;
                            if (f < n) break;
                            f = 36 - n;
                            e > v(2147483647 / f) && x("overflow");
                            e *= f;
                     }
                     e = t.length + 1;
                     M = B(y - a, e, 0 == a);
                     v(y / e) > 2147483647 - I && x("overflow");
                     I += v(y / e);
                     y %= e;
                     t.splice(y++, 0, I);
              }
       ...
       function h(l) {
              ...
              for ((t = H = I.length) && I.push("-"); t < M;) {
                     var f = 2147483647;
                     for (y = 0; y < M; ++y) {
                            e = l[y], e >= a && e < f && (f = e);
                     }
                     var n = t + 1;
                     f - a > v((2147483647 - b) / n) &&
                            x("overflow");
                     b += (f - a) * n;
                     a = f;
                     for (y = 0; y < M; ++y) {
       ...
       var p = "object" == typeof exports && exports && !exports.nodeType &&
                     exports,
              F = "object" == typeof module && module && !module.nodeType &&
                     module,
              u = "object" == typeof global && global;
       if (
              u.global === u || u.window === u ||
              u.self === u
       ) r = u;
       var J = /^xn--/,
              C = /[^\x20-\x7E]/,
       ...
       var D = {
              ...
              toASCII: function (l) {
                     return m(l, function (t) {
                            return C.test(t) ? "xn--" + h(t) : t;
                     });
              },
              toUnicode: function (l) {
                     return m(l, function (t) {
                            return J.test(t) ? z(t.slice(4).toLowerCase()) : t;
                     });
              },
       };
       if (
              ...
              if (module.exports == p) F.exports = D;
              else for (A in D) D.hasOwnProperty(A) && (p[A] = D[A]);
       } else r.punycode = D;
})(
       /* Uncaught TypeError: Cannot set properties of undefined (setting 'punycode') */
...
(function (r, x) {
       "object" === typeof module && module.exports
              ...
              : "function" === typeof define && define.amd
              ? define(x)
              : r.SecondLevelDomains = x(r);
})(
       /* Uncaught TypeError: Cannot set properties of undefined (setting 'punycode') */

       globalThis,
       function (r) {
              var x = r && r.SecondLevelDomains,
                     k = {
                            list: {
                            ...
                            has: function (m) {
                                   var d = m.lastIndexOf(".");
                                   if (0 >= d || d >= m.length - 1) return !1;
                                   var q = m.lastIndexOf(".", d - 1);
                                   if (0 >= q || q >= d - 1) return !1;
                                   var B = k.list[m.slice(d + 1)];
                                   return B
                                          ? 0 <=
                                                 B.indexOf(
                                                        " " +
                            ...
                            get: function (m) {
                                   var d = m.lastIndexOf(".");
                                   if (0 >= d || d >= m.length - 1) return null;
                                   var q = m.lastIndexOf(".", d - 1);
                                   if (0 >= q || q >= d - 1) return null;
                                   var B = k.list[m.slice(d + 1)];
                                   return !B ||
                                                 0 >
                                                        B.indexOf(
                            ...
                            noConflict: function () {
                                   r.SecondLevelDomains === this &&
                                          (r.SecondLevelDomains = x);
                                   return this;
                            },
                     };
              return k;
...
(function (r, x) {
       "object" === typeof module && module.exports
              ...
              : "function" === typeof define && define.amd
              ? define(["./punycode", "./IPv6", "./SecondLevelDomains"], x)
              : r.URI = x(r.punycode, r.IPv6, r.SecondLevelDomains, r);
})(
       /* Uncaught TypeError: Cannot set properties of undefined (setting 'punycode') */
       ...
       function (r, x, k, m) {
              function d(a, b) {
                     var c = 1 <= arguments.length, e = 2 <= arguments.length;
              ...
              function B(a) {
                     return void 0 === a
                            ? "Undefined"
                            : String(Object.prototype.toString.call(a)).slice(
                                   8,
                                   -1,
                            );
              }
              ...
              function h(a, b) {
                     var c = {}, e;
                     if ("RegExp" === B(b)) c = null;
                     else if (z(b)) {
                            var f = 0;
                            for (e = b.length; f < e; f++) c[b[f]] = !0;
                     } else c[b] = !0;
                     f = 0;
              ...
              function F(a, b) {
                     if (!z(a) || !z(b) || a.length !== b.length) return !1;
                     a.sort();
                     b.sort();
              ...
              function C(a) {
                     return encodeURIComponent(a).replace(/[!'()*]/g, J)
                            .replace(
                                   /\*/g,
                                   "%2A",
                            );
              ...
              var v = m && m.URI;
              d.version = "1.19.11";
              var g = d.prototype, A = Object.prototype.hasOwnProperty;
              d._parts = function () {
                     return {
                            protocol: null,
                            username: null,
              ...
              d.leading_whitespace_expression =
                     /^[\x00-\x20\u00a0\u1680\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\ufeff]+/;
              ...
              d.characters = {
                     ...
                     urnpath: {
                            encode: {
                                   expression:
                                          /%(21|24|27|28|29|2A|2B|2C|3B|3D|40)/ig,
                                   map: {
                                          "%21": "!",
                                          "%24": "$",
                                          "%27": "'",
              ...
              var D = { encode: "encode", decode: "decode" },
                     l,
                     t = function (a, b) {
                            return function (c) {
                                   try {
              ...
              for (l in D) {
                     d[l + "PathSegment"] = t("pathname", D[l]),
                            d[l + "UrnPathSegment"] = t("urnpath", D[l]);
              }
              D = function (a, b, c) {
                     return function (e) {
                            var f = c
                                   ...
                                   : d[b];
                            e = (e + "").split(a);
                            for (var n = 0, E = e.length; n < E; n++) {
                                   e[n] = f(e[n]);
                            }
                            return e.join(a);
                     };
              };
              d.decodePath = D("/", "decodePathSegment");
              d.decodeUrnPath = D(":", "decodeUrnPathSegment");
              d.recodePath = D("/", "encodePathSegment", "decode");
              d.recodeUrnPath = D(":", "encodeUrnPathSegment", "decode");
              d.encodeReserved = t("reserved", "encode");
              d.parse = function (a, b) {
                     b ||= { preventInvalidHostname: d.preventInvalidHostname };
                     a = a.replace(d.leading_whitespace_expression, "");
                     a = a.replace(d.ascii_tab_whitespace, "");
                     var c = a.indexOf("#");
                     -1 < c &&
                     ...
                     c = a.indexOf("?");
                     -1 < c &&
                            (b.query = a.substring(c + 1) || null,
                                   a = a.substring(0, c));
                     a = a.replace(/^(https?|ftp|wss?)?:+[/\\]*/i, "$1://");
                     a = a.replace(/^[/\\]{2,}/i, "//");
                     "//" === a.substring(0, 2)
                            ? (b.protocol = null,
                                   a = a.substring(2),
              ...
              d.parseHost = function (a, b) {
                     ...
                     if ("[" === a.charAt(0)) {
                            ...
                            f = a.indexOf(":", f + 1);
                            -1 !== f && (-1 === e || f < e)
                                   ? (b.hostname = a.substring(0, c) || null,
                                          b.port = null)
                                   : (e = a.substring(0, c).split(":"),
                                          b.hostname = e[0] || null,
                                          b.port = e[1] || null);
                     }
                     b.hostname && "/" !== a.substring(c).charAt(0) &&
                            (c++, a = "/" + a);
                     b.preventInvalidHostname &&
                            d.ensureValidHostname(b.hostname, b.protocol);
              ...
              d.parseUserinfo = function (a, b) {
                     ...
                     var e = a.indexOf("/"),
                            f = a.lastIndexOf("@", -1 < e ? e : a.length - 1);
                     -1 < f && (-1 === e ||
                                   f < e)
                            ? (a = a.substring(0, f).split(":"),
                                   b.username = a[0] ? d.decode(a[0]) : null,
                                   a.shift(),
                                   b.password = a[0]
                                          ? d.decode(a.join(":"))
                                          : null,
              ...
              d.parseQuery = function (a, b) {
                     ...
                     var c = {};
                     a = a.split("&");
                     for (var e = a.length, f, n, E = 0; E < e; E++) {
                            if (
                                   f = a[E].split("="),
                                          n = d.decodeQuery(f.shift(), b),
                                          f = f.length
                                                 ? d.decodeQuery(f.join("="), b)
                                                 : null,
                                          "__proto__" !== n
                            ) {
                                   if (A.call(c, n)) {
              ...
              d.build = function (a) {
                     ...
                     a.urn || !b && !a.hostname || (b += "//", c = !0);
                     b += d.buildAuthority(a) || "";
                     "string" === typeof a.path &&
                            ("/" !== a.path.charAt(0) && c && (b += "/"),
                                   b += a.path);
                     "string" === typeof a.query && a.query &&
                            (b += "?" + a.query);
                     "string" === typeof a.fragment && a.fragment &&
                            (b += "#" + a.fragment);
                     return b;
              };
              ...
              d.buildQuery = function (a, b, c) {
                     var e = "", f, n;
                     for (f in a) {
                            if ("__proto__" !== f && A.call(a, f)) {
                                   if (z(a[f])) {
                                          var E = {};
                                          var K = 0;
                                          for (n = a[f].length; K < n; K++) {
                                                 void 0 !== a[f][K] &&
                                                        void 0 ===
                                                               E[
                                                                      a[f][K] +
              ...
              d.buildQueryParameter = function (a, b, c) {
                     return d.encodeQuery(a, c) +
                            (null !== b ? "=" + d.encodeQuery(b, c) : "");
              };
              d.addQuery = function (a, b, c) {
                     if ("object" === typeof b) {
                            for (var e in b) {
                                   A.call(b, e) && d.addQuery(a, e, b[e]);
                            }
              ...
              d.removeQuery = function (a, b, c) {
                     ...
                     if (z(b)) {
                            ...
                            for (e in a) b.test(e) && (a[e] = void 0);
                     } else if ("object" === typeof b) {
                            for (e in b) {
                                   A.call(b, e) && d.removeQuery(a, e, b[e]);
                            }
                     } else if ("string" === typeof b) {
                            void 0 !==
                                          c
              ...
              d.hasQuery = function (a, b, c, e) {
                     ...
                     switch (B(c)) {
                            case "Undefined":
                                   return b in a;
                            case "Boolean":
                                   return a = !(z(a[b]) ? !a[b].length : !a[b]),
                                          c === a;
                            case "Function":
                                   return !!c(a[b], b, a);
                            case "Array":
                                   return z(a[b]) ? (e ? p : F)(a[b], c) : !1;
                            case "RegExp":
                                   return z(a[b])
                                          ? e ? p(a[b], c) : !1
                                          : !(!a[b] || !a[b].match(c));
              ...
              d.withinString = function (a, b, c) {
                     ...
                     var e = c.start || d.findUri.start,
                            ...
                            n = c.trim || d.findUri.trim,
                            E = c.parens || d.findUri.parens,
                            K = /[a-z0-9-]=["']?$/i;
                     for (e.lastIndex = 0;;) {
                            var L = e.exec(a);
                            if (!L) break;
                            ...
                            var O = P + a.slice(P).search(f);
                            N = a.slice(P, O);
                            for (O = -1;;) {
                                   var Q = E.exec(N);
                                   if (!Q) break;
                                   O = Math.max(O, Q.index + Q[0].length);
                            }
                            N = -1 < O
                                   ? N.slice(0, O) + N.slice(O).replace(n, "")
                                   : N.replace(n, "");
                            N.length <= L[0].length ||
              ...
              d.noConflict = function (a) {
                     if (a) {
                            return a = { URI: this.noConflict() },
                                   m.URITemplate &&
                                   "function" ===
                                          typeof m.URITemplate.noConflict &&
                                   (a.URITemplate = m.URITemplate.noConflict()),
                                   m.IPv6 &&
                                   "function" === typeof m.IPv6.noConflict &&
                                   (a.IPv6 = m.IPv6.noConflict()),
                                   m.SecondLevelDomains &&
                                   "function" ===
                                          typeof m.SecondLevelDomains
                                                 .noConflict &&
                                   (a.SecondLevelDomains = m.SecondLevelDomains
                                          .noConflict()),
                                   a;
                     }
                     m.URI === this && (m.URI = v);
              ...
              g.href = function (a, b) {
                     ...
                     var e = a instanceof d,
                            f = "object" === typeof a &&
                                   (a.hostname || a.path || a.pathname);
                     a.nodeName &&
                            (f = d.getDomAttribute(a), a = a[f] || "", f = !1);
              ...
              g.is = function (a) {
                     ...
                     this._parts.hostname &&
                            (L = !1,
                                   c = d.ip4_expression.test(
                                          this._parts.hostname,
                                   ),
                                   e = d.ip6_expression.test(
                                          this._parts.hostname,
                                   ),
                                   b = c || e,
                                   n = (f = !b) && k &&
                                          k.has(this._parts.hostname),
                                   E = f &&
                                          d.idn_expression.test(
                                                 this._parts.hostname,
                                          ),
                                   K = f &&
                                          d.punycode_expression.test(
                                                 this._parts.hostname,
                                          ));
              ...
              var H = g.protocol, y = g.port, I = g.hostname;
              ...
              g.origin = function (a, b) {
                     ...
                     a = d(a);
                     this.protocol(a.protocol()).authority(a.authority()).build(
                            !b,
                     );
                     return this;
              };
              ...
              g.userinfo = function (a, b) {
                     if (this._parts.urn) return void 0 === a ? "" : this;
                     if (void 0 === a) {
                            return (a = d.buildUserinfo(this._parts))
              ...
              g.domain = function (a, b) {
                     ...
                     if (void 0 === a) {
                            ...
                            if (
                                   (a = this._parts.hostname.match(/\./g)) &&
                                   2 > a.length
                            ) return this._parts.hostname;
                            b = this._parts.hostname.length -
                                   this.tld(b).length - 1;
                            b = this._parts.hostname.lastIndexOf(".", b - 1) +
                                   1;
                            return this._parts.hostname.substring(b) || "";
                     }
                     ...
                     if (!this._parts.hostname || this.is("IP")) {
                            ...
                            var c = new RegExp(q(this.domain()) + "$");
              ...
              g.tld = function (a, b) {
                     ...
                     if (void 0 === a) {
                            ...
                            a = this._parts.hostname.lastIndexOf(".");
                            a = this._parts.hostname.substring(a + 1);
                            return !0 !== b && k && k.list[a.toLowerCase()]
                                   ? k.get(this._parts.hostname) || a
                                   : a;
                     }
                     if (a) {
                            if (a.match(/[^a-zA-Z0-9-]/)) {
                                   if (k && k.is(a)) {
                                          ...
                                          this._parts.hostname = this._parts
                                                 .hostname
                                                 .replace(c, a);
                                   } else {
                                          throw new TypeError(
                                   ...
                                   this._parts.hostname = this._parts.hostname
                                          .replace(
                                                 c,
                                                 a,
                                          );
              ...
              g.directory = function (a, b) {
                     ...
                     if (void 0 === a || !0 === a) {
                            ...
                            b = this._parts.path.length -
                                   this.filename().length - 1;
                            b = this._parts.path.substring(0, b) ||
                                   (this._parts.hostname ? "/" : "");
                            return a ? d.decodePath(b) : b;
                     }
              ...
              g.filename = function (a, b) {
                     ...
                     if ("string" !== typeof a) {
                            ...
                            b = this._parts.path.lastIndexOf("/");
                            b = this._parts.path.substring(b + 1);
                            return a ? d.decodePathSegment(b) : b;
                     }
                     var c = !1;
              ...
              g.segmentCoded = function (a, b, c) {
                     ...
                     if (z(b)) {
                            ...
                            b = "string" === typeof b || b instanceof String
                                   ? d.encode(b)
                                   : b;
                     }
              ...
              g.setQuery = function (a, b, c) {
                     ...
                     if ("string" === typeof a || a instanceof String) {
                            ...
                            for (var f in a) A.call(a, f) && (e[f] = a[f]);
                     } else {
                            throw new TypeError(
                                   "URI.addQuery() accepts an object, string as the name parameter",
                            );
              ...
              g.normalize = function () {
                     return this._parts.urn
                            ? this.normalizeProtocol(!1).normalizePath(!1)
                                   .normalizeQuery(!1).normalizeFragment(!1)
                                   .build()
                            : this.normalizeProtocol(!1).normalizeHostname(!1)
                                   .normalizePort(!1).normalizePath(!1)
                                   .normalizeQuery(
                                          !1,
              ...
              g.normalizeProtocol = function (a) {
                     "string" === typeof this._parts.protocol &&
                            (this._parts.protocol = this._parts.protocol
                                   .toLowerCase(),
                                   this.build(!a));
                     return this;
              };
              g.normalizeHostname = function (a) {
                     this._parts.hostname &&
                            (this.is("IDN") && r
                                   ? this._parts.hostname = r.toASCII(
                                          this._parts.hostname,
                                   )
                                   : this.is("IPv6") && x &&
                                          (this._parts.hostname = x.best(
                                                 this._parts.hostname,
                                          )),
                                   this._parts.hostname = this._parts.hostname
                                          .toLowerCase(),
              ...
              g.normalizePort = function (a) {
                     "string" === typeof this._parts.protocol &&
                            this._parts.port ===
                                   d.defaultPorts[this._parts.protocol] &&
              ...
              g.normalizePath = function (a) {
                     ...
                     if (!b) return this;
                     if (this._parts.urn) {
                            return this._parts.path = d.recodeUrnPath(
                                   this._parts.path,
                            ),
                                   this.build(!a),
                                   this;
                     ...
                     for (;;) {
                            ...
                            var n = b.substring(0, f).lastIndexOf("/");
                            -1 === n && (n = f);
                            b = b.substring(0, n) + b.substring(f + 3);
                     }
              ...
              g.readable = function () {
                     ...
                     a._parts.hostname &&
                            (a.is("punycode") && r
                                   ? (b += r.toUnicode(a._parts.hostname),
                                          a._parts.port &&
                                          (b += ":" + a._parts.port))
                                   : b += a.host());
                     a._parts.hostname && a._parts.path &&
                            "/" !== a._parts.path.charAt(0) && (b += "/");
                     b += a.path(!0);
                     if (a._parts.query) {
                            for (
                                   var c = "",
                                          e = 0,
                                          f = a._parts.query.split("&"),
                                          n = f.length;
                                   e < n;
                                   e++
                            ) {
              ...
              g.relativeTo = function (a) {
                     ...
                     if (
                            ...
                            null === c.protocol && null === c.username &&
                            null === c.password &&
                            c.hostname === e.hostname && c.port === e.port
                     ) c.hostname = null, c.port = null;
                     else return b.build();
                     if (f === a) return c.path = "", b.build();
                     f = d.commonPath(f, a);
                     if (!f) return b.build();
                     e = e.path.substring(f.length).replace(/[^\/]*$/, "")
                            .replace(
                                   /.*?\//g,
                                   "../",
                            );
              ...
              g.equals = function (a) {
                     ...
                     if (
                            b.toString() !==
                                   c.toString() || f.length !== n.length
                     ) return !1;
                     b = d.parseQuery(f, this._parts.escapeQuerySpace);
                     n = d.parseQuery(n, this._parts.escapeQuerySpace);
                     for (e in b) {
                            if (A.call(b, e)) {
                                   if (!z(b[e])) {
                                          if (b[e] !== n[e]) return !1;
                     ...
                     for (e in n) if (A.call(n, e) && !a[e]) return !1;
                     return !0;
              };
...
(function (r, x) {
       "object" === typeof module && module.exports
              ? module.exports = x(require("./URI"))
              : "function" === typeof define && define.amd
              ? define(["./URI"], x)
              : r.URITemplate = x(r.URI, r);
})(
       /* Uncaught TypeError: Cannot set properties of undefined (setting 'punycode') */
       ...
       function (r, x) {
              function k(h) {
                     if (k._cache[h]) return k._cache[h];
              ...
              k.LITERAL_PATTERN = /[<>{}"`^| \\]/;
              k.expand = function (h, p, F) {
                     var u = z[h.operator], J = u.named ? "Named" : "Unnamed";
                     h = h.variables;
                     var C = [], w, G;
                     for (G = 0; w = h[G]; G++) {
                            var v = p.get(w.name);
                            if (0 === v.type && F && F.strict) {
                                   throw Error(
                            ...
                            if (v.val.length) {
                                   ...
                                   C.push(k["expand" + J](
                                          ...
                                          u,
                                          w.explode,
                                          w.explode && u.separator || ",",
                                          w.maxlength,
                                          w.name,
                                   ));
                            } else v.type && C.push("");
                     }
                     return C.length ? u.prefix + C.join(u.separator) : "";
              };
              k.expandNamed = function (h, p, F, u, J, C) {
                     var w = "", G = p.encode;
                     p = p.empty_name_separator;
                     var v = !h[G].length, g = 2 === h.type ? "" : r[G](C), A;
                     var D = 0;
                     for (A = h.val.length; D < A; D++) {
                            if (J) {
                                   var l = r[G](h.val[D][1].substring(0, J));
                                   2 === h.type &&
                                          (g = r[G](
                                                 h.val[D][0].substring(0, J),
                                          ));
                            } else {
                                   v
                                          ? (l = r[G](h.val[D][1]),
              ...
              k.expandUnnamed = function (h, p, F, u, J) {
                     var C = "", w = p.encode;
                     p = p.empty_name_separator;
                     var G = !h[w].length, v;
                     var g = 0;
                     for (v = h.val.length; g < v; g++) {
                            if (J) {
                                   var A = r[w](h.val[g][1].substring(0, J));
                            } else {
                                   G
                                          ? (A = r[w](h.val[g][1]),
                                                 h[w].push([
              ...
              k.noConflict = function () {
                     x.URITemplate === k && (x.URITemplate = d);
                     return k;
              };
              B.expand = function (h, p) {
                     var F = "";
                     this.parts && this.parts.length || this.parse();
                     h instanceof m || (h = new m(h));
                     for (var u = 0, J = this.parts.length; u < J; u++) {
                            F += "string" === typeof this.parts[u]
                                   ? this.parts[u]
                                   : k.expand(this.parts[u], h, p);
                     }
                     return F;
              };
              B.parse = function () {
                     var h = this.expression,
                            p = k.EXPRESSION_PATTERN,
                            F = k.VARIABLE_PATTERN,
                            u = k.VARIABLE_NAME_PATTERN,
                            J = k.LITERAL_PATTERN,
                            C = [],
                            w = 0,
                            G = function (t) {
                     ...
                     for (p.lastIndex = 0;;) {
                            var v = p.exec(h);
                            if (null === v) {
                                   C.push(G(h.substring(w)));
                                   break;
                            } else {
                                   C.push(G(h.substring(w, v.index))),
                                          w = v.index + v[0].length;
                            }
                            if (!z[v[1]]) {
                                   throw Error(
                                          'Unknown Operator "' + v[1] +
                                                 '" in "' +
                                                 v[0] + '"',
                                   );
                            }
              ...
              m.prototype.get = function (h) {
                     ...
                     if (void 0 !== this.cache[h]) return this.cache[h];
                     this.cache[h] = F;
                     p = "[object Function]" ===
                                   String(Object.prototype.toString.call(p))
                            ? p(h)
                            : "[object Function]" ===
                     ...
                     if (void 0 !== p && null !== p) {
                            if (
                                   ...
                                   for (u in p) {
                                          q.call(p, u) && void 0 !== p[u] &&
                                                 null !== p[u] &&
                                                 F.val.push([u, String(p[u])]);
                                   }
                                   F.val.length && (F.type = 2);
                            } else F.type = 1, F.val.push([void 0, String(p)]);
                     }
                     return F;
              };
              r.expand = function (h, p) {
                     h = (new k(h)).expand(p);
                     return new r(h);
              };
              return k;
